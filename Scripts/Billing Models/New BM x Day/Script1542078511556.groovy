...
WebUI.setText(findTestObject('Object Repository/Billing Models/input_Name_resource_name'), ('AUT' + today) + '-BMXDAY')

WebUI.selectOptionByValue(findTestObject('Billing Models/select_Bill by cycle'), '3', true)

WebUI.selectOptionByValue(findTestObject('Billing Models/select_First'), '2', true)

WebUI.selectOptionByValue(findTestObject('Billing Models/select_Sunday'), '3', true)
