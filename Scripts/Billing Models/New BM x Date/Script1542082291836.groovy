...
WebUI.setText(findTestObject('Object Repository/Billing Models/input_Name_resource_name'), ('AUT' + today) + '-BMXDATE')

WebUI.selectOptionByValue(findTestObject('Billing Models/select_Bill by cycle'), '2', true)

WebUI.setText(findTestObject('Object Repository/Billing Models/input_Subscription will bill o'), '1')
