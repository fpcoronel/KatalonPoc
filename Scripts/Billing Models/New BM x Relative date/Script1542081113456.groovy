...
WebUI.setText(findTestObject('Object Repository/Billing Models/input_Name_resource_name'), ('AUT' + today) + '-BMXRelativeDate')

WebUI.selectOptionByValue(findTestObject('Billing Models/select_Bill by cycle'), '5', true)

WebUI.setText(findTestObject('Billing Models/BM-xSCHEDULE/input_Subscription will bill o'), '1')

WebUI.selectOptionByValue(findTestObject('Billing Models/select_Month(s)'), '1', true)
