...
WebUI.click(findTestObject('Page_Bundles/Page_Add Product/label_Pre-built'))

WebUI.setText(findTestObject('Page_Add Product/input_SKU_product_sku'), 'SKU-AUT1234')

WebUI.setText(findTestObject('Page_Add Product/input_Name_product_name'), ('AUT' + today) + ' Pat-PB')
...
WebUI.click(findTestObject('Page_Bundles/div_(343) AUT1112 Pat-STD'))

WebUI.click(findTestObject('Page_Bundles/input_Bundle Products_form-con'))

WebUI.setText(findTestObject('Page_Bundles/input_Bundle Products_form-con'), '2')
