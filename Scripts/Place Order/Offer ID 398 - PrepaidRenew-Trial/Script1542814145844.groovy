...
'Selects Offer ID 398'
WebUI.selectOptionByValue(findTestObject('LL -Place Order Page/Offer Select'), '398', false)
...
WebUI.selectOptionByValue(findTestObject('LL -Place Order Page/Prepaid Terms Select'), '3', false)
...
WebUI.setText(findTestObject('LL -Place Order Page/Shipping First Name Input'), 'Offer ID 398 - Trial | ')
...
WebUI.verifyTextPresent('By Lime Light CRM API - Product 207 was purchased using offer 398, billing model 240. ', false)
