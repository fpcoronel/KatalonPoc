...
WebUI.waitForElementVisible(findTestObject('LL -Place Order Page/Trial Checkbox'), 8)
...
WebUI.setText(findTestObject('LL -Place Order Page/Shipping First Name Input'), 'Offer ID 394 |')
