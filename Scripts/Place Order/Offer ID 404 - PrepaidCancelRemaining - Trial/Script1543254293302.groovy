...
'Selects Offer ID 404'
WebUI.selectOptionByValue(findTestObject('LL -Place Order Page/Offer Select'), '404', false)
...
WebUI.setText(findTestObject('LL -Place Order Page/Shipping First Name Input'), 'Offer ID 404 - Trial | ')
...
WebUI.verifyTextPresent('By Lime Light CRM API - Product 207 was purchased using offer 404, billing model 240. ', false)
