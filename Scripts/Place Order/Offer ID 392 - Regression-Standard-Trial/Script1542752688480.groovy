...
'Selects Offer ID 392'
WebUI.selectOptionByValue(findTestObject('LL -Place Order Page/Offer Select'), '392', false)
...
WebUI.setText(findTestObject('LL -Place Order Page/Shipping First Name Input'), 'Offer ID 392 - Trial | ')
